...
def manhattanHeuristic(position, problem):
    ...
    # TODO: Implement function to calculate manhattan distance to gaol

    return abs(problem.goal[0] - position[0]) + abs(problem.goal[1] - position[1])

def euclideanHeuristic(position, problem):
    "The Euclidean distance heuristic for a PositionSearchProblem"
    # TODO: Implement function to calculate euclidean distance to gaol

    return ((problem.goal[0] - position[0])**2 + (problem.goal[1] - position[1])**2)**.5
